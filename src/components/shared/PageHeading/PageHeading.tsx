...
const PageHeading: FC<TPageHeadingProps> = ({ subHeading, children, ...props }) => {
    return (
        <div className='min-h-[calc(70vh - 84px] -mt-[84px] pt-[84px]' style={{ backgroundImage: "url(https://i.ibb.co.com/hXqgVzT/11.jpg)", backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed" }}>
