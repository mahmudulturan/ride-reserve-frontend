...
const SectionHeading: FC<ISectionHeadingProps> = ({ subHeading, heading, align = "center", className, ...props }) => {
    return (
        <div className={cn(` flex flex-col ${align === "left" ? "items-start justify-start" : align === "right" ? "items-end justify-end" : align === "center" ? "items-center justify-center text-center" : ""}  my-6`, className)} {...props}>
