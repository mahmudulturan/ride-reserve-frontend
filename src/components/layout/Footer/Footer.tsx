                    ...
                    <div className='space-y-3'>
                        ...
                        <div className='pt-3'>
                            <div className='relative'>
                                <Input className='bg-transparent border-primaryColorLight dark:border-primaryColor focus-visible:ring-transparent  focus-visible:ring-offset-0  dark:placeholder:text-white dark:text-white dark:bg-transparent py-7 pr-[42px] rounded-full' placeholder='Enter your email' />
