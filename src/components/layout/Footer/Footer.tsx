    ...
    return (
        <div className=''>
            <div className='wrapper py-10 '>
                ...
                <div className='my-6 flex items-start justify-between'>
                    ...
                    <div>
                        ...
                        <div className='text-sm font-light  space-y-1 my-3'>
                            <Link to={"#"} className='flex items-center gap-1 text-[#ada9ad] hover:text-primaryColor'>
                    ...
                    <div className='space-y-3'>
                        ...
                        <p className='text-sm max-w-xs font-light text-slate-200'>Want to be notified about our services. Just sign up and we'll send you a notification by email.</p>
                        <div className='pt-3'>
                            <div className='relative'>
                                <Input className='bg-transparent border-primaryColor focus-visible:ring-transparent  focus-visible:ring-offset-0  placeholder:text-white text-white py-7 pr-[42px] rounded-full' placeholder='Enter your email' />
                ...
                {/* copyright section */}
                <div>
                    <p className='text-xs font-extralight'>@{year} <span className='text-white font-normal border-b-[1.5px] border-primaryColor'>Ride Reserve</span>. All rights reserved.</p>
