...
interface ISelectFeaturesProps {
    features: string[];
    setFeatures: React.Dispatch<React.SetStateAction<string[]>>;
}

const SelectFeatures: FC<ISelectFeaturesProps> = ({ features, setFeatures }) => {
